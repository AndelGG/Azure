...
from exceptions.service_error import TokenTypeError, VerificationError
from schemas.auth import TokenResponse, Payload
...
def create_access_token(
    ...
    to_encode = data.copy()
    expire = datetime.datetime.now(datetime.UTC) + datetime.timedelta(minutes=timeout)
...
def create_refresh_token(
    ...
    to_encode = data.copy()
    expire = datetime.datetime.now(datetime.UTC) + datetime.timedelta(days=timeout)
